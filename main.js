...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    "22/11",
    "terça",
    createGame("argentina", "07:00", "./assets/icon-arabia-saudita.svg") +
  ...
  createCard(
    ...
    createGame("tunísia", "07:00", "austrália") +
      createGame("polônia", "10:00", "./assets/icon-arabia-saudita.svg") +
  ...
  createCard(
    ...
    createGame("tunísia", "12:00", "frança") +
      ...
      createGame("./assets/icon-arabia-saudita.svg", "16:00", "méxico")
  ) +
  createCard(
    "01/12",
    "quinta",
